  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.DialogContent
        {...props}
        className={cn(
          'fixed z-50 right-0 top-0 bottom-0 w-full sm:w-[400px] h-screen border-l border-zinc-900 bg-zinc-950 p-8',
          props.className
        )}
      />
    </DialogPortal>
...
export function DialogDescription(
  ...
  return (
    <DialogPrimitive.DialogDescription
      {...props}
      className={cn('text-zinc-400 text-sm leading-relaxed', props.className)}
    />
  )
}
